...
public class Main {
    public static void main(String[] args) {
        ...
        Point p2 = new Point("Second Point", 3, 6);
        Point p3 = new Point("Third Point", 3, 6);
        Point p4 = new Point("Fourth  Point", 3, 6);
        Point p5 = new Point("Fifth  Point", 3, 6);
        Point p6 = new Point("Sixth  Point", 3, 6);
        Point p7 = new Point("Seventh  Point", 3, 6);
        Point p8 = new Point("Eighth  Point", 3, 6);
        Point p9 = new Point("Ninth  Point", 3, 6);
        Point p10 = new Point("Tenth Point", 3, 6);
